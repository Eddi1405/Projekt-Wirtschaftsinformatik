MERGE INTO USERS AS target
    USING (SELECT -1 AS ID, NULL AS USERNAME, NULL AS PASSWORD, NULL AS EMAIL,
                  ...
                  NULL AS FONT_SIZE, FALSE AS EYE_TRACKING, FALSE AS SIGN_LANGUAGE,
    ...
    WHEN NOT MATCHED THEN
        INSERT (ID, USERNAME, PASSWORD, EMAIL, DARK_MODE, DE_EN, CONTRAST,
                FONT_SIZE, EYE_TRACKING, SIGN_LANGUAGE, ROLE, LEARNINGTYPE)
            VALUES (-1, NULL, NULL, NULL, FALSE, FALSE, FALSE, NULL, FALSE, FALSE, 'ANONYMOUS', NULL);
