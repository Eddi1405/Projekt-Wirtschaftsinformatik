...
export default function Main() {
  ...
  <ul>
    <li>
    <a href="#"><img src="Icons/menue.png" width="30px" height="30px"/>  
    <p>Menu</p>
    </a>
    </li>
...
<div className="searchbar">
  ...
  <p className="navRobotText">Du bist nun im Hauptmenü <br/><br/> 
  Du kannst rechts an der Leiste die Anzeigeeinstellungen nach Belieben ändern </p>
  <a href="#">  
  <img src="Icons/loudness.png" width="70px" height="60px" className="iconLoud"/>
    </a>  
  
  </div>


  <img src="images/divlab.png" classname="menuLogo"width="180px" height="120px"/>  
    ...
    <div className="page">
        <div className="content">
             <div className="content-toolbar_toggle-container">
                <button id="toolbar_toggle" className="btn toolbar_toggle" onClick={openBar}>
        ...
        <div className="toolbar">
            ...
            <div className="toolbar-easy_language-container">
                <img className="easy_language-icon" src="Icons/easy_language_icon.png"/>
            ...
            <div className="toolbar-eyetracking-container">
                <img className="eyetracking-icon" src="Icons/eyetracking_icon.png"/>
                <p>Augensteuerung</p>
            </div>
            ...
            <div className="toolbar-sign_language-container">
              <img className="sign_language-icon" src="Icons/sign_language_icon.png"/>
              <p>Gebärdensprache</p>
            </div>
        </div>
    </div>
